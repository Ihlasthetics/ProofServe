...
/**
 * Parse JSON only after a complete syntax pass has proved that every object has
 * unique, decoded member names. Fastify's body limit is still enforced before
 * this parser runs; the depth limit bounds this parser's recursive work.
 */
